# Generated by Django 2.1.7 on 2019-04-16 00:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('penalty', models.CharField(choices=[('NORMAL', '異常なし'), ('SCRATCHED', '取消'), ('EXCLUDED', '除外'), ('FAIL_TO_FINISH', '中止'), ('DISQUALIFIED', '失格'), ('DISQUALIFIED_AND_PLACED', '降着'), ('REMOUNT', '再騎乗')], max_length=255, verbose_name='異常区分')),
                ...
                ('run_style', models.CharField(choices=[('FRONT_RUNNER', '逃げ'), ('STALKER', '先行'), ('OTP', '差し'), ('OTP_STRETCH', '追込'), ('OTP_GOOD_POS', '好位差し'), ('VERSATILE', '自在')], max_length=255, verbose_name='レース脚質')),
                ('purse', models.FloatField()),
                ('c4_race_line', models.CharField(choices=[('INNERMOST', '最内'), ('INNER', '内'), ('MIDDLE', '中'), ('OUTER', '外'), ('OUTERMOST', '大外')], help_text='1:最内,2:内,3:中,4:外,5:大外', max_length=255, verbose_name='４角コース取り')),
                ('prel_jockey_idx', models.FloatField(help_text='基準オッズと騎手の連対率の関係を基に算出された指数値', verbose_name='騎手指数')),
                ('prel_info_idx', models.FloatField(help_text='基準オッズ、厩舎指数、調教指数等様々な情報を基に算出された指数値', verbose_name='情報指数')),
                ('prel_total_idx', models.FloatField(help_text='ＩＤＭ、騎手指数、情報指数を合計した値', verbose_name='総合指数')),
                ...
                ('prel_improvement', models.CharField(choices=[('AA', 'AA'), ('A', 'A'), ('B', 'B'), ('C', 'C'), ('?', '?')], max_length=255, verbose_name='前日上昇度コード')),
                ...
                ('trainer_outlook', models.CharField(choices=[('OUTSTANDING', 'デキ抜群'), ('IMPROVING', '上昇'), ('NO_CHANGE', '平行線'), ('DOWNWARD_TREND', 'やや下降気味'), ('POOR', 'デキ落ち')], max_length=255, verbose_name='調教矢印コード')),
                ('stable_outlook', models.CharField(choices=[('SUPER_CONFIDENT', '超強気'), ('CONFIDENT', '強気'), ('NO_CHANGE', '現状維持'), ('NOT_CONFIDENT', '弱気')], max_length=255, verbose_name='厩舎評価コード')),
                ('jockey_exp_1o2_place_rate', models.FloatField(help_text='騎手Ａが単勝基準オッズＢの馬に乗った場合の過去の成績を集計し、算出された連対率', verbose_name='騎手期待連対率')),
                ('paddock_observed_hoof', models.CharField(choices=[('01', '大ベタ'), ('02', '中ベタ'), ('03', '小ベタ'), ('04', '細ベタ'), ('05', '大立'), ('06', '中立'), ('07', '小立'), ('08', '細立'), ('09', '大標準'), ('10', '中標準'), ('11', '小標準'), ('12', '細標準'), ('17', '大標起'), ('18', '中標起'), ('19', '小標起'), ('20', '細標起'), ('21', '大標ベ'), ('22', '中標ベ'), ('23', '小標ベ'), ('24', '細標ベ')], max_length=255, verbose_name='蹄コード')),
                ('yield_track_apt', models.CharField(choices=[('STRONG', '得意'), ('NORMAL', '普通'), ('WEAK', '苦手')], max_length=255, verbose_name='重適正コード')),
                ('blinker', models.CharField(choices=[('FIRST_TIME_USE', '初装着'), ('RETRY', '再装着'), ('USING', 'ブリンカ')], max_length=255, verbose_name='ブリンカー')),
        ...
        migrations.AddField(
            ...
            name='figure_overall_1',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='jrdb.SpecialMentionCode'),
        ),
        migrations.AddField(
            model_name='contender',
            name='figure_overall_2',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='jrdb.SpecialMentionCode'),
        ),
        migrations.AddField(
            model_name='contender',
            name='figure_overall_3',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='jrdb.SpecialMentionCode'),
        ),
        migrations.AddField(
            model_name='contender',
        ...
        migrations.AddField(
            model_name='contender',
            name='jockey',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jrdb.Jockey', verbose_name='騎手'),
        ),
        migrations.AddField(
            model_name='contender',
            name='pace_flow',
        ...
        migrations.AddField(
            model_name='contender',
            name='trainer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jrdb.Trainer', verbose_name='調教師'),
        ),
