# Generated by Django 2.1.7 on 2019-05-06 22:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('c1_track_bias', django.contrib.postgres.fields.ArrayField(base_field=models.SmallIntegerField(), null=True, size=3, verbose_name='トラックバイアス（１角）')),
                ('c2_track_bias', django.contrib.postgres.fields.ArrayField(base_field=models.SmallIntegerField(), null=True, size=3, verbose_name='トラックバイアス（２角）')),
                ('bs_track_bias', django.contrib.postgres.fields.ArrayField(base_field=models.SmallIntegerField(), null=True, size=3, verbose_name='トラックバイアス（向正）')),
                ('c3_track_bias', django.contrib.postgres.fields.ArrayField(base_field=models.SmallIntegerField(), null=True, size=3, verbose_name='トラックバイアス（３角）')),
                ('c4_track_bias', django.contrib.postgres.fields.ArrayField(base_field=models.SmallIntegerField(), null=True, size=5, verbose_name='トラックバイアス（４角）')),
                ('hs_track_bias', django.contrib.postgres.fields.ArrayField(base_field=models.SmallIntegerField(), null=True, size=5, verbose_name='トラックバイアス（直線）')),
