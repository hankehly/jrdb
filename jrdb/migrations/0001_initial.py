# Generated by Django 2.1.7 on 2019-05-06 04:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sp_mention', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=255, null=True), size=6, verbose_name='特記コード')),
                ('horse_gear', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=255, null=True), size=8, verbose_name='馬具コード')),
                ('hoof_overall', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=255, null=True), size=3, verbose_name='総合')),
                ('hoof_front_left', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=255, null=True), size=3, verbose_name='左前')),
                ('hoof_front_right', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=255, null=True), size=3, verbose_name='右前')),
                ('hoof_back_left', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=255, null=True), size=3, verbose_name='左後')),
                ('hoof_back_right', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=255, null=True), size=3, verbose_name='右後')),
