    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('race_line', models.CharField(choices=[('INNERMOST', '最内'), ('INNER', '内'), ('MIDDLE', '中'), ('OUTER', '外'), ('OUTERMOST', '大外')], max_length=255, null=True, verbose_name='コース取り')),
                ('improvement', models.CharField(choices=[('AA', 'AA'), ('A', 'A'), ('B', 'B'), ('C', 'C'), ('?', '?')], max_length=255, null=True, verbose_name='上昇度コード')),
                ('physique', models.CharField(choices=[('FAT', '太い'), ('OVERWEIGHT', '余裕'), ('GOOD', '良い'), ('NORMAL', '普通'), ('THIN', '細い'), ('FRESH', '張り'), ('LOOSE', '緩い')], max_length=255, null=True, verbose_name='馬体コード')),
                ('demeanor', models.CharField(choices=[('GOOD_CONDITION', '状態良'), ('NORMAL', '平凡'), ('UNSTABLE', '不安定'), ('EXCITED', 'イレ込'), ('GOOD_SPIRIT', '気合良'), ('LACKING_SPIRIT', '気不足'), ('RESTLESS', 'チャカ'), ('EXCITED_AND_RESTLESS', 'イレチ（イレ込+チャカつき）')], max_length=255, null=True, verbose_name='気配コード')),
                ('pace_cat', models.CharField(choices=[('HIGH', 'ハイ'), ('MEDIUM', '平均'), ('SLOW', 'スロー')], max_length=255, null=True, verbose_name='馬ペース')),
                ...
                ('weight_reduction', models.CharField(choices=[('REDUCE_1K', '1K減'), ('REDUCE_2K', '2K減'), ('REDUCE_3K', '3K減')], max_length=255, null=True, verbose_name='')),
                ...
                ('prel_run_style', models.CharField(choices=[('FRONT_RUNNER', '逃げ'), ('STALKER', '先行'), ('OTP', '差し'), ('OTP_STRETCH', '追込'), ('OTP_GOOD_POS', '好位差し'), ('VERSATILE', '自在')], max_length=255, null=True, verbose_name='前日脚質')),
                ...
                ('big_bet_idx', models.SmallIntegerField(null=True, verbose_name='万券指数')),
                ...
                ('prior_context_surface', models.CharField(choices=[('NO_CHANGE', '変化なし'), ('CHANGE', 'トラック替り(芝ダ替り)'), ('FIRST', '初トラック(初芝,初ダ,初障)')], max_length=255, null=True, verbose_name='芝ダ障害フラグ')),
                ('is_longest_race_dist_yet', models.BooleanField(null=True, verbose_name='距離フラグ')),
                ('prior_context_race_class', models.CharField(choices=[('NO_CHANGE', '変化なし'), ('POST_RISE_RANK_FIRST', '昇級初戦'), ('RANK_LOWERED', '降級'), ('ATTEMPT_RISE_RANK', '格上挑戦')], max_length=255, null=True, verbose_name='クラスフラグ')),
                ...
                ('sp_mention', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=255, null=True), null=True, size=6, verbose_name='特記コード')),
                ('horse_gear', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=255, null=True), null=True, size=8, verbose_name='馬具コード')),
                ('hoof_overall', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=255, null=True), null=True, size=3, verbose_name='総合')),
                ('hoof_front_left', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=255, null=True), null=True, size=3, verbose_name='左前')),
                ('hoof_front_right', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=255, null=True), null=True, size=3, verbose_name='右前')),
                ('hoof_back_left', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=255, null=True), null=True, size=3, verbose_name='左後')),
                ('hoof_back_right', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=255, null=True), null=True, size=3, verbose_name='右後')),
                ...
                ('training_style', models.CharField(choices=[('01', 'スパルタ'), ('02', '標準多め'), ('03', '乗込'), ('04', '一杯平均'), ('05', '標準'), ('06', '馬ナリ平均'), ('07', '急仕上げ'), ('08', '標準少め'), ('09', '軽目'), ('10', '連闘'), ('11', '調教なし')], max_length=255, null=True, verbose_name='調教タイプ')),
                ('training_course_cat', models.CharField(choices=[('1', '坂路調教'), ('2', 'コース調教'), ('3', '併用(坂路、コース併用)'), ('4', '障害（障害練習）'), ('5', '障害他（障害練習＋α）'), ('0', '他（調教なし、不明）')], max_length=255, null=True, verbose_name='調教コース種別')),
                ('trained_hill', models.BooleanField(help_text='坂路', null=True, verbose_name='坂')),
                ('trained_wood_chip', models.BooleanField(help_text='ウッドコース', null=True, verbose_name='Ｗ')),
                ('trained_dirt', models.BooleanField(help_text='ダートコース', null=True, verbose_name='ダ')),
                ('trained_turf', models.BooleanField(help_text='芝コース', null=True, verbose_name='芝')),
                ('trained_pool', models.BooleanField(help_text='プール調教', null=True, verbose_name='プ')),
                ('trained_obstacle', models.BooleanField(help_text='障害練習', null=True, verbose_name='障')),
                ('trained_poly_track', models.BooleanField(help_text='ポリトラック', null=True, verbose_name='ポ')),
                ('training_distance', models.CharField(choices=[('LONG', '長め'), ('NORMAL', '標準'), ('SHORT', '短め'), ('TWO_RUNS', '２本'), ('OTHER', '他（調教なし、不明）')], max_length=255, null=True, verbose_name='調教距離')),
                ('training_emphasis', models.CharField(choices=[('F3F', 'テン重点'), ('MID', '中間重点'), ('L3F', '終い重点'), ('AVG', '平均的'), ('OTHER', '他（調教なし、不明）')], max_length=255, null=True, verbose_name='調教重点')),
                ('warm_up_time_idx', models.PositiveSmallIntegerField(null=True, verbose_name='追切指数')),
                ('training_result_idx', models.PositiveSmallIntegerField(null=True, verbose_name='仕上指数')),
                ('training_amount_eval', models.CharField(choices=[('LARGE', '多い'), ('NORMAL', '普通'), ('SMALL', '少ない'), ('VERY_LITTLE', '非常に少ない')], max_length=255, null=True, verbose_name='調教量評価')),
                ('training_result_idx_change', models.CharField(choices=[('BOLSTER_MAX', '++(攻め強化大)'), ('BOLSTER', '+ (攻め強化)'), ('NO_CHANGE', '(平行線)'), ('WEAKEN', '- (攻め弱化)')], max_length=255, null=True, verbose_name='仕上指数変化')),
                ('training_comment', models.CharField(max_length=255, null=True, verbose_name='調教コメント')),
                ('training_comment_date', models.DateField(null=True, verbose_name='コメント年月日')),
                ('training_evaluation', models.CharField(choices=[('BEST', '◎'), ('GOOD', '○'), ('OK', '△')], max_length=255, null=True, verbose_name='調教評価')),
            ],
            options={
                'db_table': 'contenders',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('symbol', models.CharField(choices=[('NA', 'NA'), ('01', '○抽'), ('02', '□抽'), ('03', '○父'), ('04', '○市'), ('05', '○地'), ('06', '○外'), ('07', '○父○抽'), ('08', '○父○市'), ('09', '○父○地'), ('10', '○市○地'), ('11', '○外○地'), ('12', '○父○市○地'), ('15', '○招'), ('16', '○招○外'), ('17', '○招○父'), ('18', '○招○市'), ('19', '○招○父○市'), ('20', '○父○外'), ('21', '□地'), ('22', '○外□地'), ('23', '○父□地'), ('24', '○市□地'), ('25', '○父○市□地'), ('26', '□外'), ('27', '○父□外')], max_length=255, null=True, verbose_name='馬記号')),
                ...
                ('owner_name', models.CharField(max_length=255, null=True, verbose_name='馬主名')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weather', models.CharField(choices=[('FINE', '晴'), ('CLOUDY', '曇'), ('DRIZZLE', '小雨'), ('RAINY', '雨'), ('LIGHT_SNOW', '小雪'), ('SNOW', '雪')], max_length=255, null=True, verbose_name='天候')),
                ...
                ('turf_cond', models.CharField(choices=[('GREAT', '絶好'), ('GOOD', '良'), ('SLIGHT_ROUGH', '稍荒'), ('ROUGH', '荒')], max_length=255, null=True, verbose_name='芝馬場状態')),
                ('turf_cond_inner', models.CharField(choices=[('GREAT', '絶好'), ('GOOD', '良'), ('SLIGHT_ROUGH', '稍荒'), ('ROUGH', '荒')], max_length=255, null=True, verbose_name='芝馬場状態内')),
                ('turf_cond_mid', models.CharField(choices=[('GREAT', '絶好'), ('GOOD', '良'), ('SLIGHT_ROUGH', '稍荒'), ('ROUGH', '荒')], max_length=255, null=True, verbose_name='芝馬場状態中')),
                ('turf_cond_outer', models.CharField(choices=[('GREAT', '絶好'), ('GOOD', '良'), ('SLIGHT_ROUGH', '稍荒'), ('ROUGH', '荒')], max_length=255, null=True, verbose_name='芝馬場状態外')),
                ('turf_speed_shift', models.SmallIntegerField(null=True, verbose_name='芝馬場差')),
                ('hs_speed_shift_innermost', models.SmallIntegerField(null=True, verbose_name='直線馬場差最内')),
                ('hs_speed_shift_inner', models.SmallIntegerField(null=True, verbose_name='直線馬場差内')),
                ('hs_speed_shift_mid', models.SmallIntegerField(null=True, verbose_name='直線馬場差中')),
                ('hs_speed_shift_outer', models.SmallIntegerField(null=True, verbose_name='直線馬場差外')),
                ('hs_speed_shift_outermost', models.SmallIntegerField(null=True, verbose_name='直線馬場差大外')),
                ('dirt_cond', models.CharField(choices=[('GREAT', '絶好'), ('GOOD', '良'), ('SLIGHT_ROUGH', '稍荒'), ('ROUGH', '荒')], max_length=255, null=True, verbose_name='ダ馬場状態')),
                ('dirt_cond_inner', models.CharField(choices=[('GREAT', '絶好'), ('GOOD', '良'), ('SLIGHT_ROUGH', '稍荒'), ('ROUGH', '荒')], max_length=255, null=True, verbose_name='ダ馬場状態内')),
                ('dirt_cond_mid', models.CharField(choices=[('GREAT', '絶好'), ('GOOD', '良'), ('SLIGHT_ROUGH', '稍荒'), ('ROUGH', '荒')], max_length=255, null=True, verbose_name='ダ馬場状態中')),
                ('dirt_cond_outer', models.CharField(choices=[('GREAT', '絶好'), ('GOOD', '良'), ('SLIGHT_ROUGH', '稍荒'), ('ROUGH', '荒')], max_length=255, null=True, verbose_name='ダ馬場状態外')),
                ('dirt_speed_shift', models.SmallIntegerField(null=True, verbose_name='ダ馬場差')),
                ('turf_type', models.CharField(choices=[('NATURAL', '野芝'), ('WESTERN', '洋芝'), ('MIXED', '混生')], max_length=255, null=True, verbose_name='芝種類')),
                ('grass_height', models.FloatField(null=True, verbose_name='草丈')),
                ('used_rolling_compactor', models.BooleanField(null=True, verbose_name='転圧')),
                ('used_anti_freeze_agent', models.BooleanField(null=True, verbose_name='凍結防止剤')),
                ('mm_precipitation', models.FloatField(null=True, verbose_name='中間降水量')),
            ],
            options={
                'db_table': 'programs',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('furlong_times', django.contrib.postgres.fields.ArrayField(base_field=models.FloatField(null=True), null=True, size=None, verbose_name='ハロンタイム')),
                ('c1_track_bias', django.contrib.postgres.fields.ArrayField(base_field=models.SmallIntegerField(null=True), null=True, size=3, verbose_name='トラックバイアス（１角）')),
                ('c2_track_bias', django.contrib.postgres.fields.ArrayField(base_field=models.SmallIntegerField(null=True), null=True, size=3, verbose_name='トラックバイアス（２角）')),
                ('bs_track_bias', django.contrib.postgres.fields.ArrayField(base_field=models.SmallIntegerField(null=True), null=True, size=3, verbose_name='トラックバイアス（向正）')),
                ('c3_track_bias', django.contrib.postgres.fields.ArrayField(base_field=models.SmallIntegerField(null=True), null=True, size=3, verbose_name='トラックバイアス（３角）')),
                ('c4_track_bias', django.contrib.postgres.fields.ArrayField(base_field=models.SmallIntegerField(null=True), null=True, size=5, verbose_name='トラックバイアス（４角）')),
                ('hs_track_bias', django.contrib.postgres.fields.ArrayField(base_field=models.SmallIntegerField(null=True), null=True, size=5, verbose_name='トラックバイアス（直線）')),
                ...
                ('pace_cat', models.CharField(choices=[('HIGH', 'ハイ'), ('MEDIUM', '平均'), ('SLOW', 'スロー')], max_length=255, null=True)),
        ...
        migrations.AddField(
            model_name='race',
            name='program',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jrdb.Program'),
        ),
        migrations.AddField(
            model_name='program',
            name='racetrack',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pedigree_damsire', to='jrdb.Pedigree'),
        ),
        migrations.AddField(
            model_name='horse',
            name='pedigree_sire',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pedigree_sire', to='jrdb.Pedigree'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='contender',
            name='horse',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='jrdb.Horse', verbose_name='馬'),
        ),
        migrations.AddField(
            model_name='contender',
