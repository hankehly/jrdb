from jrdb.docspecs.util import TEMPLATE_ROW
...
TEMPLATE = [
    ...
    for row in [
        ...
        ['', '年月日', None, '8', '9', '19', 'YYYYMMDD <-暫定版より順序'],
        ['horse_name', '馬名', None, '36', 'X', '27', '全角１８文字 <-入れ替え'],
        ['distance', '距離', None, '4', '9999', '63', None],
        ['', '芝ダ障害コード', None, '1', '9', '67', '1:芝, 2:ダート, 3:障害'],
        ['', '右左', None, '1', '9', '68', '1:右, 2:左, 3:直, 9:他'],
        ['', '内外', None, '1', '9', '69', '1:通常(内), 2:外, 3,直ダ, 9:他'],
        ...
        ['', '確定単勝オッズ', None, '6', 'ZZZ9.9', '175', None],
        ['', '確定単勝人気順位', None, '2', '99', '181', None],
        ...
        ['', '騎手コード', None, '5', '9', '323', '騎手マスタとリンク'],
        ['', '調教師コード', None, '5', '9', '328', '調教師マスタとリンク'],
        ['', '馬体重', None, '3', '999', '333', 'データ無:スペース'],
        ['', '馬体重増減', None, '3', 'XZ9', '336', '符号+数字２桁、データ無:スペース'],
        ['', '天候コード', None, '1', '9', '339', 'コード表参照'],
        ['', 'コース', None, '1', 'X', '340', '1:A,2:A1,3:A2,4:B,5:C,6:D'],
        ['', 'レース脚質', None, '1', 'X', '341', '脚質コード参照'],
        ['', '単勝', None, '7', 'ZZZZZZ9', '342', '単位（円）'],
        ...
        ['', '予備', None, '4', 'X', '371', 'スペース'],
        ['', '改行', None, '2', 'X', '375', 'ＣＲ・ＬＦ'],
    ]
]
