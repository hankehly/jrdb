...
class KAB(Template):
    ...
    items = [
        ...
        ChoiceItem(
            "開催区分", 1, 14, "jrdb.Program.host_category", choices.HOST_CATEGORY.options()
        ),
        ...
        ChoiceItem(
            ...
            2,
            22,
            "jrdb.Program.turf_cond",
            choices.TRACK_CONDITION_KA.options(),
        ),
        ChoiceItem(
            "芝馬場状態内",
            1,
            24,
            "jrdb.Program.turf_cond_inner",
            choices.TRACK_CONDITION_KA.options(),
        ),
        ChoiceItem(
            "芝馬場状態中",
