...
class KAB(Template):
    ...
    items = [
        ...
        ['', '開催区分', None, '1', '9', '15', '1:関東, 2:関西, 3:ローカル'],
        ['day_of_week', '曜日', None, '2', 'X', '16', '日－土'],
        ...
        ['', '芝馬場差', None, '3', '9', '28', '推'],
        ['', '直線馬場差最内', None, '2', '99', '31', '推'],
        ['', '直線馬場差内', None, '2', '99', '33', '推'],
        ['', '直線馬場差中', None, '2', '99', '35', '推'],
        ['', '直線馬場差外', None, '2', '99', '37', '推'],
        ['', '直線馬場差大外', None, '2', '99', '39', '推'],
        ['dirt_track_condition_code', 'ダ馬場状態コード', None, '2', '9', '41', '推 →JRDBデータコード表'],
        ['', 'ダ馬場状態内', None, '1', '9', '43', '推 1:絶好, 2:良, 3,稍荒, 4:荒'],
        ['', 'ダ馬場状態中', None, '1', '9', '44', '推 1:絶好, 2:良, 3,稍荒, 4:荒'],
        ['', 'ダ馬場状態外', None, '1', '9', '45', '推 1:絶好, 2:良, 3,稍荒, 4:荒'],
        ['', 'ダ馬場差', None, '3', '9', '46', '推'],
        ['', 'データ区分', None, '1', '9', '49', '1:特別登録,2:想定確定,3:枠確定,4:前日'],
        ['', '連続何日目', None, '2', '9', '50', '日数'],
        ['', '芝種類', None, '1', 'X', '52', '1:野芝, 2:洋芝, 3:混生'],
        ['', '草丈', None, '4', 'Z9.9', '53', '単位cm'],
        ['', '転圧', None, '1', 'X', '57', '1:転圧, 0:無し'],
        ['', '凍結防止剤', None, '1', 'X', '58', '1:凍結防止剤散布, 0:無し'],
        ['', '中間降水量', None, '5', 'ZZ9.9', '59', '単位mm'],
        ['reserved', '予備', None, '7', 'X', '64', 'スペース'],
        ['newline', '改行', None, '2', 'X', '71', 'ＣＲ・ＬＦ'],
        ['', 'データ区分', None, '1', '9', '49', '1:特別登録,2:想定確定,3前日'],
        ['', 'データ区分', None, '1', '9', '49', '1:特別登録,2:想定確定,3:枠確定,4:前日']
    ]
