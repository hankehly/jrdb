...
class KYI(Template):
    ...
    items = [
        ...
        ChoiceItem(
            ...
            1,
            89,
            "jrdb.Contender.prel_run_style",
            choices.RUNNING_STYLE.options(),
        ),
        ...
        ChoiceItem(
            ...
            1,
            91,
            "jrdb.Contender.prel_improvement",
        ...
        ChoiceItem(
            ...
            1,
            154,
            "jrdb.Contender.trainer_outlook",
            choices.TRAINER_HORSE_EVALUATION.options(),
        ),
        ChoiceItem(
            "厩舎評価コード",
            1,
            155,
            "jrdb.Contender.stable_outlook",
            choices.STABLE_HORSE_EVALUATION.options(),
        ),
        ...
        ChoiceItem(
            ...
            2,
            163,
            "jrdb.Contender.paddock_observed_hoof",
            choices.PADDOCK_OBSERVED_HOOF.options(),
        ),
        ChoiceItem(
            "重適性コード",
            1,
            165,
            "jrdb.Contender.yield_track_apt",
            choices.YIELDING_TRACK_APTITUDE.options(),
        ),
        # TODO: why is each horse different? IGNORE
        # IntegerItem('jrdb.race_class', 'クラスコード', 2, '99', '167'),
        # ===以下第４版にて追加===
        ChoiceItem(
            "ブリンカー", 1, 170, "jrdb.Contender.blinker", choices.BLINKER.options()
        ),
        ...
        ChoiceItem(
            ...
            1,
            186,
            "jrdb.Contender.weight_reduction",
            choices.WEIGHT_REDUCTION.options(),
        ),
        ...
        ChoiceItem(
            "芝適性コード", 1, 333, "jrdb.Contender.turf_apt", choices.APTITUDE_CODE.options()
        ),
        ChoiceItem(
            "ダ適性コード", 1, 334, "jrdb.Contender.dirt_apt", choices.APTITUDE_CODE.options()
        ),
        ...
        ChoiceItem(
            ...
            1,
            394,
            "jrdb.Contender.race_development_symbol",
            choices.RACE_DEVELOPMENT_SYMBOL.options(),
        ),
        # ===以下第６a版にて追加===
        ...
        ForeignKeyItem(
            "馬主会コード", 2, 444, "jrdb.Horse.owner_racetrack", "jrdb.Racetrack.code"
        ),
        ChoiceItem(
            "馬記号コード", 2, 446, "jrdb.Horse.symbol", choices.HORSE_SYMBOL.options()
        ),
        ...
        ChoiceItem(
            ...
            1,
            468,
            "jrdb.Contender.transport_category",
            choices.TRANSPORT_CATEGORY.options(),
        ),
        # ===以下第９版にて追加===
        ...
        ChoiceItem(
            ...
            1,
            477,
            "jrdb.Contender.figure_overall",
            choices.FIGURE_OVERALL.options(),
        ),
        ChoiceItem(
            "背中", 1, 478, "jrdb.Contender.length_back", choices.FIGURE_LENGTH.options()
        ),
        ChoiceItem(
            "胴", 1, 479, "jrdb.Contender.length_body", choices.FIGURE_LENGTH.options()
        ),
        ChoiceItem(
            "尻", 1, 480, "jrdb.Contender.size_rump", choices.FIGURE_SIZE.options()
        ),
        ...
        ChoiceItem(
            ...
            1,
            481,
            "jrdb.Contender.size_hindquarters",
            choices.FIGURE_ANGLE.options(),
        ),
        ChoiceItem(
            "腹袋", 1, 482, "jrdb.Contender.size_belly", choices.FIGURE_SIZE.options()
        ),
        ChoiceItem(
            "頭", 1, 483, "jrdb.Contender.size_head", choices.FIGURE_SIZE.options()
        ),
        ChoiceItem(
            "首", 1, 484, "jrdb.Contender.length_neck", choices.FIGURE_LENGTH.options()
        ),
        ChoiceItem(
            "胸", 1, 485, "jrdb.Contender.size_breast", choices.FIGURE_SIZE.options()
        ),
        ChoiceItem(
            "肩", 1, 486, "jrdb.Contender.size_shoulder", choices.FIGURE_ANGLE.options()
        ),
        ChoiceItem(
            "前長", 1, 487, "jrdb.Contender.length_front", choices.FIGURE_LENGTH.options()
        ),
        ChoiceItem(
            "後長", 1, 488, "jrdb.Contender.length_rear", choices.FIGURE_LENGTH.options()
        ),
        ChoiceItem(
            "前幅", 1, 489, "jrdb.Contender.stride_front", choices.FIGURE_STRIDE.options()
        ),
        ChoiceItem(
            "後幅", 1, 490, "jrdb.Contender.stride_rear", choices.FIGURE_STRIDE.options()
        ),
        ChoiceItem(
            "前繋",
            1,
            491,
            "jrdb.Contender.length_pastern_front",
            choices.FIGURE_LENGTH.options(),
        ),
        ChoiceItem(
            "後繋",
            1,
            492,
            "jrdb.Contender.length_pastern_rear",
            choices.FIGURE_LENGTH.options(),
        ),
        ...
        ChoiceItem(
            ...
            1,
            494,
            "jrdb.Contender.tail_swing_intensity",
            choices.TAIL_SWING_INTENSITY.options(),
        ),
        ForeignKeyItem(
            "体型総合１",
            3,
            501,
            "jrdb.Contender.figure_sp_mention_1",
            "jrdb.SpecialMentionCode.key",
        ),
        ForeignKeyItem(
            "体型総合２",
            3,
            504,
            "jrdb.Contender.figure_sp_mention_2",
            "jrdb.SpecialMentionCode.key",
        ),
        ForeignKeyItem(
            "体型総合３",
            3,
            507,
            "jrdb.Contender.figure_sp_mention_3",
            "jrdb.SpecialMentionCode.key",
        ),
        ForeignKeyItem(
            "馬特記１",
            3,
            510,
            "jrdb.Contender.horse_sp_mention_1",
            "jrdb.SpecialMentionCode.key",
        ),
        ForeignKeyItem(
            "馬特記２",
            3,
            513,
            "jrdb.Contender.horse_sp_mention_2",
            "jrdb.SpecialMentionCode.key",
        ),
        ForeignKeyItem(
            "馬特記３",
            3,
            516,
            "jrdb.Contender.horse_sp_mention_3",
            "jrdb.SpecialMentionCode.key",
        ),
        # 展開参考データ
        ...
        ChoiceItem(
            ...
            1,
            538,
            "jrdb.Contender.rank_lowered",
            choices.RANK_LOWERED.options(),
        ),
        ChoiceItem(
            "激走タイプ",
            2,
            539,
            "jrdb.Contender.flat_out_run_type",
            choices.FLAT_OUT_RUN_TYPE.options(),
        ),
        ChoiceItem(
            "休養理由分類コード",
            2,
            541,
            "jrdb.Contender.rest_reason",
            choices.REST_REASON.options(),
        ),
        # ===以下第11版にて追加===
        ChoiceItem(
            "芝ダ障害フラグ",
            1,
            543,
            "jrdb.Contender.prior_context_surface",
            choices.PRIOR_CONTEXT_SURFACE.options(),
        ),
        ...
        ChoiceItem(
            ...
            1,
            545,
            "jrdb.Contender.prior_context_race_class",
        ...
        ChoiceItem(
            ...
            1,
            622,
            "jrdb.Contender.pasture_rank",
            choices.PASTURE_RANK.options(),
        ),
        ChoiceItem(
            "厩舎ランク", 1, 623, "jrdb.Contender.stable_rank", choices.STABLE_RANK.options()
        ),
    ]
