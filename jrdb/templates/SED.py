...
class SED(Template):
    ...
    items = [
        ...
        ['open_3F_time', '前３Ｆタイム', None, '3', '999', '259', '0.1秒単位'],
        ['end_3F_time', '後３Ｆタイム', None, '3', '999', '262', '0.1秒単位'],
        ['comment', '備考', None, '24', 'X', '265', '全角１２文字（地方競馬場名等）'],
        ['reserved', '予備', None, '2', 'X', '289', 'スペース'],
        ['final_show_odds_lower_limit', '確定複勝オッズ下', None, '6', 'ZZZ9.9', '291', '最終的な複勝オッズ（下限）'],
        ...
        ['corner_4_race_line', '４角コース取り', None, '1', '9', '370', '1:最内,2:内,3:中,4:外,5:大外'],
