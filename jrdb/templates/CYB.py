...
class CYB(Template):
    ...
    items = [
        ...
        ChoiceItem(
            ...
            2,
            10,
            "jrdb.Contender.training_style",
            choices.TRAINING_STYLE.options(),
        ),
        ChoiceItem(
            "調教コース種別",
            1,
            12,
            "jrdb.Contender.training_course_cat",
            choices.TRAINING_COURSE_CATEGORY.options(),
        ),
        # 調教コース種類
        BooleanItem(
            "坂", 2, 13, "jrdb.Contender.trained_hill", value_true="01", value_false="00"
        ),
        BooleanItem(
            "Ｗ",
            2,
            15,
            "jrdb.Contender.trained_wood_chip",
            value_true="01",
            value_false="00",
        ),
        BooleanItem(
            "ダ", 2, 17, "jrdb.Contender.trained_dirt", value_true="01", value_false="00"
        ),
        BooleanItem(
            "芝", 2, 19, "jrdb.Contender.trained_turf", value_true="01", value_false="00"
        ),
        BooleanItem(
            "プ", 2, 21, "jrdb.Contender.trained_pool", value_true="01", value_false="00"
        ),
        BooleanItem(
            "障",
            2,
            23,
            "jrdb.Contender.trained_obstacle",
            value_true="01",
            value_false="00",
        ),
        BooleanItem(
            ...
            2,
            25,
            "jrdb.Contender.trained_poly_track",
            value_true="01",
            value_false="00",
        ),
        ChoiceItem(
            ...
            1,
            27,
            "jrdb.Contender.training_distance",
            choices.TRAINING_DISTANCE.options(),
        ),
        ChoiceItem(
            "調教重点",
            1,
            28,
            "jrdb.Contender.training_emphasis",
            choices.TRAINING_EMPHASIS.options(),
        ),
        ...
        ChoiceItem(
            ...
            1,
            35,
            "jrdb.Contender.training_amount_eval",
            choices.TRAINING_AMOUNT_EVAL.options(),
        ),
        ChoiceItem(
            "仕上指数変化",
            1,
            36,
            "jrdb.Contender.training_result_idx_change",
        ...
        ChoiceItem(
            ...
            1,
            85,
            "jrdb.Contender.training_evaluation",
            choices.THREE_STAGE_EVAL.options(),
        ),
    ]
