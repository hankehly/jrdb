...
class SRB(Template):
    ...
    items = [
        ...
        ['track_bias_1_cor', 'トラックバイアス（１角）', None, '3', 'X', '321', '（内、中、外）'],
        ['track_bias_2_cor', 'トラックバイアス（２角）', None, '3', 'X', '324', '（内、中、外）'],
        ['track_bias_backstretch', 'トラックバイアス（向正）', None, '3', 'X', '327', '（内、中、外）'],
        ['track_bias_3_cor', 'トラックバイアス（３角）', None, '3', 'X', '330', '（内、中、外）'],
        ['track_bias_4_cor', 'トラックバイアス（４角）', None, '3', 'X', '333', '（最内、内、中、外、大外）'],
