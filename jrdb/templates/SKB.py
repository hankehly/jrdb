...
class SKB(Template):
    ...
    items = [
        ...
        BooleanItem(
            "バンテージ", 3, 276, "jrdb.Contender.bandage", value_true="007", value_false=""
        ),
        ForeignKeyItem(
            "蹄鉄", 3, 279, "jrdb.Contender.horseshoe", "jrdb.HorseGearCode.key"
        ),
        ForeignKeyItem(
            "蹄状態", 3, 282, "jrdb.Contender.hoof_cond", "jrdb.HorseGearCode.key"
        ),
        ForeignKeyItem(
            "ソエ", 3, 285, "jrdb.Contender.periostitis", "jrdb.HorseGearCode.key"
        ),
        ForeignKeyItem(
            "骨瘤", 3, 288, "jrdb.Contender.exostosis", "jrdb.HorseGearCode.key"
        ),
    ]
