...
class Horse(models.Model):
    ...
    sex = models.CharField(
        verbose_name="性別", max_length=255, null=True, choices=choices.SEX.CHOICES()
    )
    hair_color = models.CharField(
        max_length=255, null=True, choices=choices.HAIR_COLOR.CHOICES()
    )
    symbol = models.CharField(
        verbose_name="馬記号",
        max_length=255,
        null=True,
        choices=choices.HORSE_SYMBOL.CHOICES(),
    )
    ...
    owner_racetrack = models.ForeignKey(
        "jrdb.Racetrack", models.SET_NULL, verbose_name="馬主会", null=True
    )
    ...
    pedigree_sire = models.ForeignKey(
        "jrdb.Pedigree", models.SET_NULL, null=True, related_name="pedigree_sire"
    )
    pedigree_damsire = models.ForeignKey(
        "jrdb.Pedigree", models.SET_NULL, null=True, related_name="pedigree_damsire"
    )
