...
class Program(models.Model):
    ...
    turf_cond = models.CharField('芝馬場状態', max_length=255, null=True, choices=choices.TRACK_CONDITION_KA.CHOICES())
    turf_cond_inner = models.CharField('芝馬場状態内', max_length=255, null=True, choices=choices.TRACK_CONDITION_KA.CHOICES())
    turf_cond_mid = models.CharField('芝馬場状態中', max_length=255, null=True, choices=choices.TRACK_CONDITION_KA.CHOICES())
    turf_cond_outer = models.CharField('芝馬場状態外', max_length=255, null=True, choices=choices.TRACK_CONDITION_KA.CHOICES())
    ...
    dirt_cond = models.CharField('ダ馬場状態', max_length=255, null=True, choices=choices.TRACK_CONDITION_KA.CHOICES())
    dirt_cond_inner = models.CharField('ダ馬場状態内', max_length=255, null=True, choices=choices.TRACK_CONDITION_KA.CHOICES())
    dirt_cond_mid = models.CharField('ダ馬場状態中', max_length=255, null=True, choices=choices.TRACK_CONDITION_KA.CHOICES())
    dirt_cond_outer = models.CharField('ダ馬場状態外', max_length=255, null=True, choices=choices.TRACK_CONDITION_KA.CHOICES())
    dirt_speed_shift = models.SmallIntegerField('ダ馬場差', null=True)
    turf_type = models.CharField('芝種類', max_length=255, null=True, choices=choices.TURF_TYPE.CHOICES())
