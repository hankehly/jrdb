class ChoiceMixin:
    ...
    @classmethod
    def CHOICES(self):
        return ((t[1], t[2]) for t in self.MAP)
...
class AREA(ChoiceMixin):
    ...
    KANSAI = "KANSAI"
    OTHER = "OTHER"
    MAP = (("1", KANTOU, "関東"), ("2", KANSAI, "関西"), ("3", OTHER, "他"))
...
class APTITUDE_CODE(ChoiceMixin):
    ...
    NORMAL = "NORMAL"
    WEAK = "WEAK"
    MAP = (("1", STRONG, "得意"), ("2", NORMAL, "普通"), ("3", WEAK, "苦手"))
...
class BLINKER(ChoiceMixin):
    ...
    RETRY = "RETRY"
    USING = "USING"
    MAP = (("1", FIRST_TIME_USE, "初装着"), ("2", RETRY, "再装着"), ("3", USING, "ブリンカ"))
...
class DIRECTION(ChoiceMixin):
    ...
    STRAIGHT = "STRAIGHT"
    OTHER = "OTHER"
    MAP = (("1", RIGHT, "右"), ("2", LEFT, "左"), ("3", STRAIGHT, "直"), ("4", OTHER, "他"))
...
class FIGURE_OVERALL(ChoiceMixin):
    ...
    NORMAL = "NORMAL"
    SQUARE = "SQUARE"
    MAP = (("1", RECT, "長方形"), ("2", NORMAL, "普通"), ("3", SQUARE, "正方形"))
...
class FIGURE_SIZE(ChoiceMixin):
    ...
    NORMAL = "NORMAL"
    SMALL = "SMALL"
    MAP = (("1", LARGE, "大きい"), ("2", NORMAL, "普通"), ("3", SMALL, "小さい"))
...
class FIGURE_STRIDE(ChoiceMixin):
    ...
    NORMAL = "NORMAL"
    NARROW = "NARROW"
    MAP = (("1", WIDE, "広い"), ("2", NORMAL, "普通"), ("3", NARROW, "狭い"))
...
class FIGURE_LENGTH(ChoiceMixin):
    ...
    NORMAL = "NORMAL"
    SHORT = "SHORT"
    MAP = (("1", LONG, "長い"), ("2", NORMAL, "普通"), ("3", SHORT, "短い"))
...
class HOST_CATEGORY(ChoiceMixin):
    ...
    KANSAI = "KANSAI"
    LOCAL = "LOCAL"
    MAP = (("1", KANTOU, "関東"), ("2", KANSAI, "関西"), ("3", LOCAL, "ローカル"))
...
class IMPROVEMENT(ChoiceMixin):
    ...
    C = "C"
    Q = "?"
    MAP = (("1", AA, "AA"), ("2", A, "A"), ("3", B, "B"), ("4", C, "C"), ("5", Q, "?"))
...
class PACE_CATEGORY(ChoiceMixin):
    ...
    MEDIUM = "MEDIUM"
    SLOW = "SLOW"
    MAP = (("H", HIGH, "ハイ"), ("M", MEDIUM, "平均"), ("S", SLOW, "スロー"))
...
class RANK_LOWERED(ChoiceMixin):
    ...
    DOUBLE = "DOUBLE"
    NO_CHANGE = "NO_CHANGE"
    MAP = (("1", SINGLE, "降級"), ("2", DOUBLE, "２段階降級"), ("0", NO_CHANGE, "通常"))
...
class SEX(ChoiceMixin):
    ...
    FEMALE = "FEMALE"
    CASTRATED = "CASTRATED"
    MAP = (("1", MALE, "Male"), ("2", FEMALE, "Female"), ("3", CASTRATED, "Castrated"))
...
class SURFACE(ChoiceMixin):
    ...
    DIRT = "DIRT"
    OBSTACLE = "OBSTACLE"
    MAP = (("1", TURF, "芝"), ("2", DIRT, "ダート"), ("3", OBSTACLE, "障害"))
...
class TURF_TYPE(ChoiceMixin):
    ...
    WESTERN = "WESTERN"
    MIXED = "MIXED"
    MAP = (("1", NATURAL, "野芝"), ("2", WESTERN, "洋芝"), ("3", MIXED, "混生"))
...
class WEIGHT_REDUCTION(ChoiceMixin):
    ...
    REDUCE_2K = "REDUCE_2K"
    REDUCE_3K = "REDUCE_3K"
    MAP = (("1", REDUCE_1K, "1K減"), ("2", REDUCE_2K, "2K減"), ("3", REDUCE_3K, "3K減"))
