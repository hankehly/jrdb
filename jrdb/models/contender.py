...
class Contender(BaseModel):
    ...
    race_line = models.CharField('コース取り', max_length=255, choices=choices.RACE_LINE.CHOICES())
    improvement = models.CharField('上昇度コード', max_length=255, choices=choices.IMPROVEMENT.CHOICES())
    physique = models.CharField('馬体コード', max_length=255, choices=choices.PHYSIQUE.CHOICES())
    demeanor = models.CharField('気配コード', max_length=255, choices=choices.DEMEANOR.CHOICES())

    pace_cat = models.CharField('馬ペース', max_length=255, choices=choices.PACE_CATEGORY.CHOICES())
    ...
    prel_run_style = models.CharField('前日脚質', max_length=255, choices=choices.RUNNING_STYLE.CHOICES())
